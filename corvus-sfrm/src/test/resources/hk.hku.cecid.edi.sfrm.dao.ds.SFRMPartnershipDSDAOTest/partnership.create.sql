...
(
  ...
  is_outbound_sign_requested boolean DEFAULT FALSE, 
  is_outbound_encrypt_requested boolean DEFAULT FALSE,
  is_inbound_sign_enforced boolean DEFAULT FALSE,
  is_inbound_encrypt_enforced boolean DEFAULT FALSE,
